// Number 1 Time Warp Module
// Merged from: n1-time-warp.js, n1-time-warp-boot.js

import { clampFiniteNonNegative } from "./rate.js";
import { applyAffordableUpgradeBurstForHand } from "./autobuy-burst.js";

// ==================== TIME WARP RULES (from n1-time-warp.js) ====================
...
// ==================== TIME WARP BOOT (from n1-time-warp-boot.js) ====================
...
export function createNumber1TimeWarpBoot(deps) {
    ...
    function applyTimeWarpManualAutoBuyAssistForHand(handIndex) {
        ...
        const burstResult = applyAffordableUpgradeBurstForHand(
            handIndex,
            {
                getUnlockedHands: deps.getUnlockedHands,
                getSpeedLevel: deps.getSpeedLevel,
                getCheapenLevel: deps.getCheapenLevel,
                getSlowdownLevel: deps.getSlowdownLevel,
                getHandEarnings: deps.getHandEarnings,
                getMaxCheapenLevel: deps.getMaxCheapenLevel,
                getCheapenUpgradeCost: deps.getCheapenUpgradeCost,
                getUpgradeCost: deps.getUpgradeCost,
                getSlowdownUpgradeCost: deps.getSlowdownUpgradeCost,
                getMaxSlowdownLevelCap: deps.getMaxSlowdownLevelCap,
                isSlowdownUnlocked: deps.isSlowdownUnlocked,
                buyCheapenUpgradeForHand: deps.buyCheapenUpgradeForHand,
                buySpeedUpgradeForHand: deps.buySpeedUpgradeForHand,
                buySlowdownUpgradeForHand: deps.buySlowdownUpgradeForHand,
                flushAutobuyDeferredTotalsIfAny: deps.flushAutobuyDeferredTotalsIfAny,
            ...
            },
            {
                onAfterBurst: () => {
                    ...
                    deps.addToLog(
                        "Warp auto buy assist: bought upgrades for Hand " + (handIndex + 1) + " after your manual Time Warp.",
                        "system"
                    );
                }
            }
