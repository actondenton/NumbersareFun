 ...
 \\        /
  ...
  `, // 5
    ...
    function effectFromGrants(g) {
        ...
        if (g.handUnlockStartingCount != null && g.handUnlockStartingCount > 0) {
            var husc = Number(g.handUnlockStartingCount);
            var huscStr = (typeof g.handUnlockStartingCount === "number" && isFinite(husc))
    ...
    var ASCENSION_NODES = [
        { id: 'asc_ix_00', finger: 'index', parents: [], route: 'velocity', cost: 5, branchIndex: 0, x: 50.46, y: 47.31, grants: { speedCostMult: 0.99, autoBuyDefaultOnForNewHands: true } },
        { id: 'asc_ix_01', finger: 'index', parents: ['asc_ix_00'], route: 'velocity', cost: 5, branchIndex: 1, x: 50.75, y: 45.875, grants: { cheapenCap: 1, handUnlockStartingCount: 1000 } },
        { id: 'asc_ix_02', finger: 'index', parents: ['asc_ix_01'], route: 'velocity', cost: 6, branchIndex: 2, x: 51.04, y: 44.44, grants: { autoBuyDelayMult: 0.386, handUnlockStartingCount: 10000 } },
        { id: 'asc_ix_03', finger: 'index', parents: ['asc_ix_02'], route: 'velocity', cost: 6, branchIndex: 3, x: 51.33, y: 43.005, grants: { slowdownCostMult: 0.94, handUnlockStartingCount: 100000 } },
        { id: 'asc_ix_04', finger: 'index', parents: ['asc_ix_03'], route: 'velocity', cost: 7, branchIndex: 4, x: 51.62, y: 41.57, grants: { speedCostMult: 0.99, handUnlockStartingCount: 1000000 } },
        { id: 'asc_ix_05', finger: 'index', parents: ['asc_ix_04'], route: 'velocity', cost: 8, branchIndex: 5, x: 51.91, y: 40.135, grants: { cheapenCap: 1, handUnlockStartingCount: 10000000, autoBuyAlsoCheapen: true } },
        { id: 'asc_ix_06', finger: 'index', parents: ['asc_ix_05'], route: 'velocity', cost: 9, branchIndex: 6, x: 52.2, y: 38.7, grants: { autoBuyDelayMult: 0.386 } },
        ...
        { id: 'asc_ix_09', finger: 'index', parents: ['asc_ix_08'], route: 'velocity', cost: 12, branchIndex: 9, x: 53.07, y: 34.395, grants: { cheapenCap: 1, handUnlockStartingCount: 1000000000 } },
        { id: 'asc_ix_10', finger: 'index', parents: ['asc_ix_09'], route: 'velocity', cost: 13, branchIndex: 10, x: 53.36, y: 32.96, grants: { autoBuyDelayMult: 0.386, autoBuyAlsoSlowdown: true } },
        ...
        { id: 'asc_ix_13', finger: 'index', parents: ['asc_ix_12'], route: 'velocity', cost: 18, branchIndex: 13, x: 54.23, y: 28.655, grants: { cheapenCap: 1, handUnlockStartingCount: 1000000000000 } },
        { id: 'asc_ix_14', finger: 'index', parents: ['asc_ix_13'], route: 'velocity', cost: 19, branchIndex: 14, x: 54.52, y: 27.22, grants: { autoBuyDelayMult: 0.386 } },
        ...
        { id: 'asc_ix_17', finger: 'index', parents: ['asc_ix_16'], route: 'velocity', cost: 26, branchIndex: 17, x: 55.39, y: 22.915, grants: { cheapenCap: 1, handUnlockStartingCount: 1000000000000000 } },
        { id: 'asc_ix_18', finger: 'index', parents: ['asc_ix_17'], route: 'velocity', cost: 29, branchIndex: 18, x: 55.68, y: 21.48, grants: { autoBuyDelayMult: 0.386 } },
        ...
        { id: 'asc_ix_22', finger: 'index', parents: ['asc_ix_21'], route: 'velocity', cost: 44, branchIndex: 22, x: 56.84, y: 15.74, grants: { autoBuyDelayMult: 0.386 } },
